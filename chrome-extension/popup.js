...
async function loadCards() {
  cardsList.innerHTML = '<div style="text-align: center; padding: 10px; color: #999;">Cargando...</div>';
  ...
  if (result.success && result.cards && result.cards.length > 0) {
    ...
    cardsList.innerHTML = recentCards.map(card => `
      <div class="card-item">
    ...
    cardsList.innerHTML = '<div class="empty-state">No has creado tarjetas aún.<br>Usa un formulario de pago para crear tu primera tarjeta.</div>';
  }
}
