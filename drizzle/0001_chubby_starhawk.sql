...
ALTER TABLE "transaction" ADD CONSTRAINT "transaction_virtualCardId_virtualCard_id_fk" FOREIGN KEY ("virtualCardId") REFERENCES "public"."virtualCard"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "virtualCard" ADD CONSTRAINT "virtualCard_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;